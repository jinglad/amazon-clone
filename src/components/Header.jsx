  ...
  return (
    <header>
      ...
      <div className="flex items-center bg-amazon_blue py-2 flex-grow">
        ...
        {/* search */}
        <div className="hidden sm:flex bg-yellow-400 hover:bg-yellow-500 rounded-md flex-grow cursor-pointer items-center h-10">
          <input
      ...
      {/* bottom */}
      <div className="flex items-center bg-amazon_blue-light text-white text-sm py-2 pl-6 space-x-3">
